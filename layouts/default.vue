...
<template>
    ...
    <div class="row">
      <div class="row navigation">
        <div class="d-flex justify-content-center">
          <ul class="navbar-nav h4 pt-3 pb-3">
          <li class="nav-item">
          ...
          <li class="nav-item">
              <NuxtLink to="/locksmith-near-me" class="nav-link fw-bold">Locksmith near me</NuxtLink>
          </li>
          </ul>
        </div>
      </div>
    ...
    <div class="row navigation pt-2 pb-2">
      <div class="col-12 col-lg-6">
        <div class="navigation">
          <NuxtLink to="/">
            <NuxtImg src="/images/logo.webp" class="logo" alt="logo" />
          </NuxtLink>
        </div>
      </div>
  ...
  <div class="footer mt-3">
    <footer class="p-2" style="background: #2d3246;">
      <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-6">
              <NuxtLink to="/" class="brand"><NuxtImg src="/images/logo.webp" alt="logo" /></NuxtLink>
