...
<template>
    <div class="bg-white pb-24 sm:pb-32 pt-4 pb-4 mt-4 mb-4">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <h5 class="text-center text-lg pb-4 font-semibold leading-8 text-gray-900">Trusted by the world’s most innovative teams</h5>
        <div class="mx-auto mt-10 trusted-section grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
